...
/* @var $GLOBALS['DUPX_AC'] DUPX_ArchiveConfig */
	...
	$host = parse_url($_POST['dbhost'], PHP_URL_HOST);
	$dbh = @mysqli_connect($host, $_POST['dbuser'], $_POST['dbpass'], $_POST['dbname'], $_POST['dbport']);
...
<form id='s3-input-form' method="post" class="content-form">
	...
	<div id='s3-adv-opts' style="display:none;">
		...
		<input type="checkbox" name="fullsearch" id="fullsearch" checked value="1" /> <label for="fullsearch">Use Database Full Search Mode</label><br/>
