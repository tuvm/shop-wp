...
<style>
	...
	tr.dpro-pkinfo td.get-btns button {width:100px; padding:0; margin:2px 0 0 0}
				...
				switch (parseInt(store.storage_type)) {
					...
					case DupPro.Pack.StorageTypes.local:
						if ((store.id != -2)) {
							...
							info += "<b><i class='fa fa-server'></i> Local Endpoint: '" + store.name + failed_string + cancelled_string + "'</b><br/>";
					...
					case DupPro.Pack.StorageTypes.ftp:
						...
						info += "<div style='" + styling + "'>";
						info += "<b><i class='fa fa-cloud'></i> FTP Endpoint: '" + store.name + failed_string + cancelled_string + "'</b><br/>";
					...
					case DupPro.Pack.StorageTypes.dropbox:
						...
						info += "<div style='" + styling + "'>";
						info += "<b><i class='fa fa-dropbox'></i> Dropbox Endpoint: '" + store.name + failed_string + cancelled_string + "'</b><br/>";
					...
					case DupPro.Pack.StorageTypes.gdrive:
						...
						info += "<div style='" + styling + "'>";
						info += "<b><i class='fa fa-cloud'></i> Google Drive Endpoint: '" + store.name + failed_string + cancelled_string + "'</b><br/>";
					...
					case DupPro.Pack.StorageTypes.s3:
						info += "<div style='" + styling + "'>";
						info += "<b> <i class='fa fa-cloud'></i>Amazon S3 Endpoint: '" + store.name + failed_string + cancelled_string + "'</b><br/>";
						info += "<span>Location: " + store.storage_location_string + "</span><br/>";
						info += "</div>";
					break;
					//ONEDRIVE
